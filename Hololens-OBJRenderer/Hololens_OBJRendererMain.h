...
{
    class Hololens_OBJRendererMain : public DX::IDeviceNotify
    {
    public:
        Hololens_OBJRendererMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~Hololens_OBJRendererMain();
    ...
    private:
		...
		// Pointer to the OBJRenderer object
		std::unique_ptr<OBJRenderer>									m_objRenderer;
